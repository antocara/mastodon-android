...
public class UiUtils {
    ...
    public static void launchWebBrowser(Context context, String url) {
        try {
            if (UiUtils.globalUserPreferencesDataSource.getUseCustomTabs()) {
    ...
    public static void setUserPreferredTheme(Context context) {
        context.setTheme(switch (UiUtils.globalUserPreferencesDataSource.getTheme()) {
            case AUTO ->
                    UiUtils.globalUserPreferencesDataSource.getTrueBlackTheme() ? R.style.Theme_Mastodon_AutoLightDark_TrueBlack : R.style.Theme_Mastodon_AutoLightDark;
            case LIGHT -> R.style.Theme_Mastodon_Light;
            case DARK ->
                    UiUtils.globalUserPreferencesDataSource.getTrueBlackTheme() ? R.style.Theme_Mastodon_Dark_TrueBlack : R.style.Theme_Mastodon_Dark;
        });
    }
