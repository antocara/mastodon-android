...
public class AccountActivationFragment extends ToolbarFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        lastResendTime = session.activationInfo != null ? session.activationInfo.getLastEmailConfirmationResend() : 0;
    }
    ...
    public View onCreateContentView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        AccountSession session = AccountSessionManager.getInstance().getAccount(accountID);
        String string = session.activationInfo != null ? session.activationInfo.getEmail() : "?";
        text.setText(getString( R.string.confirm_email_subtitle, string));
        updateResendTimer();
                ...
                .setCallback(new Callback<>() {
                    ...
                    public void onSuccess(Object result) {
                        ...
                        if (session.activationInfo == null) {
                            ...
                            session.activationInfo.setLastEmailConfirmationResend(System.currentTimeMillis());
                        }
                        lastResendTime = session.activationInfo.getLastEmailConfirmationResend();
